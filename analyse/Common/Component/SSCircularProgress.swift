...
//  Common
//
//  Created by Eason Lee on 2017/7/10.
//  Copyright © 2017年 Stocks. All rights reserved.
//
//  引用自 https://github.com/kaandedeoglu/KDCircularProgress
//

import UIKit

public enum SSCircularProgressGlowMode {
    case forward, reverse, constant, noGlow
}

@IBDesignable
public class SSCircularProgress: UIView, CAAnimationDelegate {
    ...
    private var progressLayer: SSCircularProgressViewLayer {
        get {
            return layer as! SSCircularProgressViewLayer
        }
    }
    ...
    @IBInspectable public var glowMode: SSCircularProgressGlowMode = .forward {
        didSet {
    ...
    override public class var layerClass: AnyClass {
        return SSCircularProgressViewLayer.self
    }
    ...
    private class SSCircularProgressViewLayer: CALayer {
        ...
        var glowMode: SSCircularProgressGlowMode = .forward
        ...
        private enum GlowConstants {
            ...
            static func glowAmount(forAngle angle: Double, glowAmount: CGFloat, glowMode: SSCircularProgressGlowMode, size: CGFloat) -> CGFloat {
                switch glowMode {
                case .forward:
        ...
        override init(layer: Any) {
            ...
            let progressLayer = layer as! SSCircularProgressViewLayer
